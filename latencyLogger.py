...
LATENCY_DIR = os.path.join(os.getcwd(), "outputs_time")
os.makedirs(LATENCY_DIR, exist_ok=True)


def log_latency(start_time: datetime, speech_start_time: datetime, context: str = "") -> str:
    """
    Simpan durasi dari awal capture hingga audio mulai diputar.
